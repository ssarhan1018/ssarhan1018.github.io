...
window.context = function( container ) {
	...
	var changed = new context.Signal();

	// All layers in this instance of context
...
context.Signal.prototype.add = function( callback ) {
	this.listeners.push( callback );
}

context.Signal.prototype.remove = function( callback ) {
	var i = this.listeners.indexOf( callback );

	if( i >= 0 ) this.listeners.splice( i, 1 );
}

context.Signal.prototype.dispatch = function() {
